...
class LoginActivity : AppCompatActivity() {
                ...
                override fun onDataChange(p0: DataSnapshot) {
                    ...
                    for (userInfo in p0.children) {
                        ...
                        if (readingUserInfo?.userEmail.equals(userLoginInfoUserNameOrUserEmail)) {
                            ...
                            Log.e("Auth Girişi Problem", "Kullanıcı adı veya Email adresi eşleşmiyor.")
    ...
    // Diğer tekniklerde Telefon yada kullanıcı adı gibi kontroller ile de giriş yapmış olabilir.
            ...
            .addOnCompleteListener(object : OnCompleteListener<AuthResult> {
                override fun onComplete(p0: Task<AuthResult>) {
                    ...
                    if (p0.isSuccessful) {
                        ...
                        Toast.makeText(this@LoginActivity, "Parola Hatalı", Toast.LENGTH_LONG).show()
